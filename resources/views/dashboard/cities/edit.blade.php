...
@section('title')
    @lang('cities.actions.list') | @lang('cities.actions.edit')
@endsection

@section('content')

    {{ html()->form('POST', route('dashboard.cities.update',$city))->class('form-horizontal')->acceptsFiles()->open() }}
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('cities.actions.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
        </div>
